...
const DuringDayHabbits = () => {
  ...
  const addHabbit = async () => {
    const docRef = await addDoc(collection(db, "duringDayTasks"), {
      task: task,
              ...
              >
                ...
                >
                  {item.isDone ? (
                    <TouchableOpacity
                      onPress={async () => {
                        const task = doc(db, "duringDayTasks", item.id);
                  ...
                  <TouchableOpacity
                    onPress={async () => {
                      await deleteDoc(doc(db, "duringDayTasks", item.id));
                      setActiveIndicator(true);
                      getHabbits();
                    }}
                    style={{
...
export default DuringDayHabbits;
